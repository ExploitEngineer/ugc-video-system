...
export function buildCreativeBriefPrompt(
  ...
  const system = [
    ...
    "  on-screen text always renders garbled; show busy screens/apps but keep their",
    "  text vague, and reserve crisp legible text for the hero stat and the end card.",
