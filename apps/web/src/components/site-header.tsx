...
export function SiteHeader() {
  ...
  return (
    <header
      className={cn(
        "sticky top-0 z-40 w-full transition-[padding] duration-500 ease-[cubic-bezier(0.22,1,0.36,1)]",
    ...
    >
      ...
      >
        ...
        <div className="flex items-center gap-1.5">
          ...
          >
            <Link href="/studio">
              ...
              <span className="pointer-events-none absolute inset-y-0 -left-1/3 w-1/4 -skew-x-12 bg-white/30 blur-sm transition-transform duration-700 ease-out group-hover:translate-x-[420%]" />
              Open Studio
        ...
        <motion.div
          ...
          className={cn(
            "bg-brand-gradient absolute bottom-0 left-0 h-px w-full origin-left",
            scrolled && "hidden",
          )}
        />
      </div>
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            ...
            className={cn(
              "glass-panel overflow-hidden md:hidden",
              scrolled
                ? "mx-auto mt-2 max-w-3xl rounded-2xl border border-border/60"
